...
<!-- status-covers-digest: aacbb0113294dac9 -->
...
- Data odświeżenia: **2026-08-15**. Ostatnia zmiana zachowania: **wyrenderowane
  ...
  to dopiero kontrola pozytywna. Ta sama miara jest powodem, dla którego obcy
  trap jest ZASTĘPOWANY, a nie doklejany: doklejenie uruchamiałoby raportowaną
  akcję przodka — tu `rm -rf "$WORK"` — wewnątrz każdej podpowłoki, niszcząc
  fikstury trwającego przebiegu. Zwolnienie **weryfikuje** usunięcie zamiast ufać
  ...
  **pod trapem EXIT przodka** (czyli w układzie, który pokonał pierwszą wersję
  ...
  sekcja 60 — 12 asercji, w tym cztery kontrole: obrona z wyłączonym
