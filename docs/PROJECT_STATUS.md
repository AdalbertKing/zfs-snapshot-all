...
<!-- status-covers-digest: e15ccb42d04ccd7d -->
...
- Data odświeżenia: **2026-08-13**. Ostatnia zmiana zachowania: `585d27f`
  ...
  **Werdyktu „nic do zrobienia" już nie ma**: `written=0` odzwierciedla ostatni
  ...
  (`readonly=on`) i sprawdza granicę zatwierdzenia — a potem staje.
  **Kroku niszczącego nadal nie ma.**
