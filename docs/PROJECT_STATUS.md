...
- Data odświeżenia: **2026-08-06** (dodatkowo: **REV-20260804-045 w toku** —
  ...
  niezaimplementowany. Pozostaje plasterek 4: regeneracja crontabów flotą
  przez `activate-client` + test izolacji dwóch relacji na żywo. Po
