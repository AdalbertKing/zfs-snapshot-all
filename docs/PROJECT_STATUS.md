...
<!-- status-covers-digest: 9f1fafde4e381881 -->
...
- Data odświeżenia: **2026-08-13**. Ostatnia zmiana zachowania: `9187b35`
  (2026-08-13, podgląd strategii odtworzenia dowodzi też ŻYWEGO stanu źródła,
  a rozliczone zero jest NIEDOWIEDZIONE, nie czyste — REV-118 F1 rundy 1 i 2). Faza 7 ma na main wycinek 1 (planer read-only), wycinek 2
