...
<!-- status-covers-digest: df240b512f380067 -->
...
- Data odświeżenia: **2026-08-14**. Ostatnia zmiana zachowania: wycinek WYKONANIA
  ...
  **Werdyktu „nic do zrobienia" już nie ma**: `written=0` odzwierciedla ostatni
  ...
  przyrostowym. Akceptacja jest przez GUID, nie przez kod wyjścia: najnowszy
  snapshot źródła musi nieść GUID punktu docelowego, inaczej przebieg zawiódł.
  Semantyka porażki jest rozdzielona: rollback jest atomowy, więc jego
